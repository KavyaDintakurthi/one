...
<body>
	...
	<h1 style="color: hotpink; font-size: 40px;" align="center">jenkins is ci/cd tool</h1>
	<h1 style="color: purple;font-size: 40px;" align="center">Successfully Deployed Automatically</h1>
